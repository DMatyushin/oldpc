...
let questions = [
  ...
  "Как называются цветы, вон в том милом розовом букетике?"

]

let giftFile = "Поздравляю, ты справилась! Подарок для самой-самой милой, умной и красивой девочки-коськи спрятан в месте, в котором вкусно пахнет. Приятного дня! :D"

let notesFile = [
  "7 Марта 1986 года. Сегодня по почте пришла какая-то коробка, на имя Матюшиной Н. П. Некогда смотреть что там, заныкал в укромное место. Место на всякий случай положил в запароленный архив gift.rar. Разбросал по дому подсказки, если я вдруг пароль забуду: Дурка, Красная книга, quiz",
  "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~",
     ...
     if (key === 13){ // Клавиша Enter
       ...
       switch (value) {
         case "ls":
           ...
           break;
         case "best_photo.jpg":
           printLine('<p style="text-align: center; margin: auto;"><img style="margin: auto;" src="media/best_photo.jpg" width="750" height="550"></p>');
           break;
         case "quiz.exe":
         ...
         case "colors.exe":
           ...
           break;
         case "hubble -latest":
           printLine("Подключение произведено успешно. Время ожидания менее 0.3 сек.")
